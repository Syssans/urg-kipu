...
export function ComingSoon({ title, description }: { title: string; description: string }) {
  return (
    <div>
      <Header title={title} />
      <div className="page-in mx-auto flex max-w-xl flex-col items-center gap-3 px-6 pb-28 pt-16 text-center">
        <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-border bg-surface backdrop-blur-xl">
