...
export const blatchford: Calculator = {
  ...
  fields: [
    ...
    { type: "boolean", id: "hr", label: "Fréquence cardiaque ≥ 100/min", points: 1 },
    { type: "boolean", id: "melena", label: "Méléna", points: 1 },
    { type: "boolean", id: "syncope", label: "Syncope", points: 2 },
    { type: "boolean", id: "liverDisease", label: "Hépatopathie connue", points: 2 },
    { type: "boolean", id: "heartFailure", label: "Insuffisance cardiaque connue", points: 2 },
  ],
