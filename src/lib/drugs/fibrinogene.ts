...
export const fibrinogene: Drug = {
  ...
  dosage:
    ...
    "Reconstitution : amener poudre et solvant à température ambiante, désinfecter les bouchons, transférer le solvant dans le flacon de poudre, faire tourner doucement jusqu'à dissolution complète sans agiter (solution limpide à légèrement opalescente).",
