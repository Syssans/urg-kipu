...
export const oxytocine: Drug = {
  ...
  dosage:
    "Prévention de l'hémorragie du post-partum : 5 à 10 UI en IV lente sur 1 min au moment du passage des épaules _(pur, 5 UI/mL, seringue 5 mL)_.\n" +
    "Entretien : 2 à 8 gouttes par minute, maximum 40 gouttes par minute — _1 ampoule (5 UI) dans une poche de G5 % de 500 mL_.",
  contraindications: [
