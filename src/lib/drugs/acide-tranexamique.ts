...
export const acideTranexamique: Drug = {
  ...
  dosage:
    "Choc hémorragique, adulte : 1 g en perfusion IV sur 10 min (2 ampoules de 500 mg dans 100 mL de NaCl 0,9 %), puis 1 g sur 8 h au PSE (2 ampoules + 38 mL NaCl 0,9 % = 1 g/48 mL, seringue 50 mL).\n" +
    "Enfant < 30 kg : 10 mg/kg en perfusion IV sur 10 min, dilution en fonction du poids ou pur.\n" +
