...
export const noradrenaline: Drug = {
  ...
  dosage:
    ...
    "_Sur VVP : 1/2 ampoule (4 mg soit 2 mL) + 38 mL de NaCl 0,9 % ou de G5 % (0,1 mg/mL, seringue 50 mL)._\n" +
    "_Sur VVC : 3 ampoules de 8 mg + 36 mL de NaCl 0,9 % ou de G5 % (0,5 mg/mL, seringue 50 mL)._",
