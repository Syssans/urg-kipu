...
export const sulfateMagnesium: Drug = {
  ...
  dosage:
    ...
    "Pré-éclampsie : bolus de 4 g sur 20 min (solution pure, seringue 50 mL, environ 80 mL/h) puis entretien de 1 g/h au PSE (6 g dans 40 mL de solution pure, soit 6,5 mL/h).\n" +
    "Hypokaliémie : 6 à 8 g/24 h au PSE (seringue 50 mL, dilution avec du NaCl 0,9 %).\n" +
